...
async function addAllCards() {
    ...
    people.forEach(person => {
        ...
        <section class="full-container flex flex-col ${person.Gradient} rounded-2xl">
            <section class="upper-field-section pb-4 pr-4 font-pixelify">
                ...
                <div class="info-subsection flex justify-between items-end mx-4">
                    <div class="flex items-end">
                        <h1 id="name" class="w-40 text-5xl">${person.FirstName} ${person.LastName}</h1>
            ...
            <section class="image-section flex justify-center">
                <div class="character-image relative h-80 w-[26.4rem] flex justify-center bg-gradient-to-b border-2">
                    ...
                    <p class="absolute flex left-0 bg-gradient-to-b from-gray-400 to-slate-600 w-32 h-10 justify-center items-center font-pixelify text-3xl">${person.EducationLevel}</p>
                    <img>
                </div>
            </section>
